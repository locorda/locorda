...
/// Algorithm class from Algo vocabulary
///
...
///
/// This class provides access to all properties that can be used with Algorithm.
/// [Class Reference](https://w3id.org/solid-crdt-sync/vocab/crdt-algorithms#Algorithm)
///
/// [Vocabulary Reference](https://w3id.org/solid-crdt-sync/vocab/crdt-algorithms#)
class AlgoAlgorithm {
  // Private constructor prevents instantiation
  const AlgoAlgorithm._();

  /// IRI term for the Algorithm class
