...
**Storage Format:**
Backends may store resources as individual files or as RDF Datasets (shard-level files with named graphs). Individual files reduce bandwidth, while datasets reduce remote operation overhead. Some backends let you configure this tradeoff.
