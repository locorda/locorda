...
/// PredicateMapping class from Mc vocabulary
///
...
///
/// This class provides access to all properties that can be used with PredicateMapping.
/// [Class Reference](https://w3id.org/solid-crdt-sync/vocab/merge-contract#PredicateMapping)
///
/// [Vocabulary Reference](https://w3id.org/solid-crdt-sync/vocab/merge-contract#)
class McPredicateMapping {
  // Private constructor prevents instantiation
  const McPredicateMapping._();

  /// IRI term for the PredicateMapping class
  ...
  /// rule [Expects: https://w3id.org/solid-crdt-sync/vocab/merge-contract#Rule]
  ///
