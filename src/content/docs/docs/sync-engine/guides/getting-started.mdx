...
We recommend supporting as many backends as possible. Your users then choose where their data lives:
...
Your app code stays the same regardless of which backend a user selects.
