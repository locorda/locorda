...
/// GroupIndexTemplate class from Crdt vocabulary
///
...
///
/// This class provides access to all properties that can be used with GroupIndexTemplate.
/// [Class Reference](https://w3id.org/solid-crdt-sync/vocab/idx#GroupIndexTemplate)
///
/// [Vocabulary Reference](https://w3id.org/solid-crdt-sync/vocab/idx#)
class CrdtGroupIndexTemplate {
  // Private constructor prevents instantiation
  const CrdtGroupIndexTemplate._();

  /// IRI term for the GroupIndexTemplate class
  ...
  /// groupedBy [Expects: https://w3id.org/solid-crdt-sync/vocab/idx#GroupingRule]
  ///
