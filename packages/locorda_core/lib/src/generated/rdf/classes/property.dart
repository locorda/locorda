...
class RdfProperty {
  ...
  /// domainIncludes from schemahttp vocabulary [Expects: http://schema.org/Class]
  ///
  /// Relates a property to a class that is (one of) the type(s) the property is expected to be used on.
  ///
  /// Can be used on: http://schema.org/Property
  ///
  static const schemahttpDomainIncludes = IriTerm(
    'http://schema.org/domainIncludes',
  );

  /// inverseOf from schemahttp vocabulary [Expects: http://schema.org/Property]
  ///
  /// Relates a property to a property that is its inverse. Inverse properties relate the same pairs of items to each other, but in reversed direction. For example, the 'alumni' and 'alumniOf' properties are inverseOf each other. Some properties don't have explicit inverses; in these situations RDFa and JSON-LD syntax for reverse properties can be used.
  ///
  /// Can be used on: http://schema.org/Property
  ///
  static const schemahttpInverseOf = IriTerm('http://schema.org/inverseOf');
  ...
  /// rangeIncludes from schemahttp vocabulary [Expects: http://schema.org/Class]
  ///
  /// Relates a property to a class that constitutes (one of) the expected type(s) for values of the property.
  ///
  /// Can be used on: http://schema.org/Property
  ///
  static const schemahttpRangeIncludes = IriTerm(
  ...
  /// supersededBy from schemahttp vocabulary [Expects: http://schema.org/Class, http://schema.org/Enumeration, http://schema.org/Property]
  ///
  /// Relates a term (i.e. a property, class or enumeration) to one that supersedes it.
  ///
  /// Can be used on: http://schema.org/Class, http://schema.org/Enumeration, http://schema.org/Property
  ///
  static const schemahttpSupersededBy = IriTerm(
